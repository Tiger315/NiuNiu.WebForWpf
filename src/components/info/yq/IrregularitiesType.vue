          ...
          <el-table v-loading="zLoading" element-loading-text="拼命加载中" :data="violationCase" stripe style="width: 100%;" row-key="id">
            ...
            <el-table-column fixed="left" prop="title" label="标题" min-width="280" fit show-overflow-tooltip>
              <template slot-scope="scope">
                <span style="color: #0d308c; cursor: pointer;" @click="showDetail(scope.row.xa_id)">{{scope.row.title}}</span>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="violationTypeName" label="违规类型" width="250" show-overflow-tooltip></el-table-column>
            <el-table-column prop="supervisionOrganName" label="监管机构" width="200"></el-table-column>
