  ...
  <div class="Feedback">
    ...
    <el-dialog :visible.sync="zDialog" fullscreen :before-close="beforeClose">
      <div class="dialog-box" v-loading="zLoading" style="margin:0 auto;">
        <iframe :src="showFileUrl" width="80%" :height="dataHeight" frameborder="0" style="margin-left:10%;"></iframe>
      </div>
    </el-dialog>
    <!--dialog结束-->
  </div>
...
export default {
  ...
  methods: {
    ...
    showPDF (urls) {
      console.log(urls)
      this.showFileUrl = 'https://view.officeapps.live.com/op/view.aspx?src=' + urls
      this.zDialog = true
    },
    beforeClose () {
      this.showFileUrl = ''
